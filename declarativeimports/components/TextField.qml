...
PlasmaComponents.TextField {
    ...
    RowLayout {
        ...
        PlasmaComponents.Button {
            ...
            Layout.leftMargin: Qt.application.layoutDirection === Qt.RightToLeft ? 0 : 0.7 * LatteCore.Tools.mSize(Kirigami.Theme.defaultFont).width
            Layout.rightMargin: Qt.application.layoutDirection === Qt.RightToLeft ? 0.7 * LatteCore.Tools.mSize(Kirigami.Theme.defaultFont).width : 0
